...
<template>
    <div>
        ...
        <div class="min-h-screen bg-[#0a0c1c]">
            <nav class="bg-[#060818]">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        >
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-[#060818] hover:text-indigo-200 focus:outline-none transition"
                                            >
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-[#060818]">
